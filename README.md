...
- Flow table shows dynamically installed entries after communication  
...
- Subsequent packets are forwarded directly without controller involvement  

---

## Performance Observation

- **Latency:** Very low due to single switch and same subnet  
- **Throughput:** Measured using iperf between h1 and h2  
- **Flow table:** Verified using `ovs-ofctl dump-flows s1`  
- **Packet counts:** Visible in flow table and POX logs  
...
- Confirmed flow rules are installed dynamically after communication  
...
Flow table shows dynamically installed flow rules based on MAC address matching and output actions.  
![FlowTable](Screenshot%202026-04-16%20at%2010.48.40%20AM.png)
